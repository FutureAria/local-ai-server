...
def test_public_release_check_json_cli_reports_private_key_without_key_material(
    capsys: pytest.CaptureFixture[str],
    tmp_path: Path,
) -> None:
...
def test_public_release_check_sensitive_path_payload_omits_file_content(tmp_path: Path) -> None:
    secret_value = "a" * 24
...
def test_public_release_check_json_cli_sensitive_path_omits_file_content(
    capsys: pytest.CaptureFixture[str],
    tmp_path: Path,
) -> None:
    secret_value = "a" * 24
