...
def test_tasks_doc_marks_automated_safe_contracts_done_and_keeps_e2e_manual() -> None:
    text = TASKS.read_text(encoding="utf-8")
    ...
    assert "[ ] 실제 사용자 `.md` 또는 `.txt` 문서 기준 upload/search/ask-with-docs end-to-end 재검증 결과를 paste-safe summary로 기록" in text
